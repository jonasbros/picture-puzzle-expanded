 ...
 */
export function formatUsername(username: string, duplicate: number = 1): string {
 ...
 */
export function parseUsername(formattedUsername: string): { username: string; duplicate: number } {
 ...
 */
export function addDisplayName<T extends { username: string; username_duplicate: number }>(
  user: T
